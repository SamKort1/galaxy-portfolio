...
interface AboutSkillsModalProps {
    isOpen: boolean;
    onClose: () => void;
    onDownloadCV?: () => void;
    onContact?: () => void;
...
export default function AboutSkillsModal({
    isOpen,
    onClose,
    onDownloadCV,
    onContact,
}: AboutSkillsModalProps) {
    ...
    const skillCategories = [
        ...
        },
        {
            ...
            skills: ["Node.js", "Java", "Kotlin", "Python", "PostgreSQL", "MongoDB", "REST APIs"]
        },
        {
            name: "AI & Machine Learning",
            skills: ["TensorFlow", "PyTorch", "Scikit-learn", "OpenAI API", "Computer Vision", "NLP"]
        },
        {
            name: "Cloud & DevOps",
            skills: ["AWS", "Docker", "Kubernetes", "CI/CD", "Git", "Linux", "Microservices"]
        }
    ];
        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className="relative w-[min(95vw,900px)] max-h-[90vh] overflow-hidden rounded-2xl
                ...
                >
                    ...
                    <div className="flex items-start gap-3 p-4 sm:p-5 border-b border-white/10">
                        ...
                        <div className="min-w-0">
                            <h2 className="text-lg md:text-xl font-semibold leading-tight text-white">Skills</h2>
                            <p className="text-xs text-gray-300/90 mt-0.5 line-clamp-2 max-w-[70%]">Technologies & expertise</p>
                        </div>
                                ...
                                <div key={category.name} className="space-y-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {category.skills.map((skill) => (
                                            <span
                                                key={skill}
                                                className="text-xs rounded-full px-3 py-1.5 bg-white/5 text-gray-200 border border-white/10 hover:bg-white/10 transition-colors"
                                            >
                                                {skill}
                                            </span>
                                        ))}
